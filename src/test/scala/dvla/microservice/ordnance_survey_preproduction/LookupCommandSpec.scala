...
final class LookupCommandSpec extends UnitSpec with MockitoSugar {
  ...
  "call PostcodeToAddressOSWebService" should {
    ...
    "return ordnance_survey valid sequence of UprnAddressPairs when the postcode is valid and the OS service returns seq of results" in {
      val dpa = resultBuilder(organisationName = Some("DVLA"), buildingName = Some("ASH COTTAGE"), thoroughfareName = Some("OLD BYSTOCK DRIVE"), dependentLocality = Some("BYSTOCK"), postTown = "EXMOUTH", postCode = "EX8 5EQ")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa ++ dpa ++ dpa))))
    ...
    "not throw when an address contains ordnance_survey building number that contains letters" in {
      val dpa = resultBuilder(buildingNumber = Some("50ABC"), thoroughfareName = Some("FAKE ROAD"), postTown = "FAKE TOWN", postCode = "EX8 1SN")
    ...
    "FLAT 1, 52, SALISBURY ROAD, EXMOUTH, EX8 1SN should return in the format FLAT 1, 52 SALISBURY ROAD, EXMOUTH, EX8 1SN" in {
      val dpa = resultBuilder(subBuildingName = Some("FLAT 1"), buildingNumber = Some("52"), thoroughfareName = Some("SALISBURY ROAD"), postTown = "EXMOUTH", postCode = "EX8 1SN")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "FLAT 1, MONTPELLIER COURT, MONTPELLIER ROAD, EXMOUTH, EX8 1JP should return in the format FLAT 1, MONTPELLIER COURT, MONTPELLIER ROAD, EXMOUTH, EX8 1JP" in {
      val dpa = resultBuilder(subBuildingName = Some("FLAT 1"), buildingName = Some("MONTPELLIER COURT"), thoroughfareName = Some("MONTPELLIER ROAD"), postTown = "EXMOUTH", postCode = "EX8 1JP")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "FLAT 1, 13A, CRANLEY GARDENS, LONDON, SW7 3BB should return in the format FLAT 1, 13A, CRANLEY GARDENS, LONDON, SW7 3BB" in {
      val dpa = resultBuilder(subBuildingName = Some("FLAT 1"), buildingName = Some("13A"), thoroughfareName = Some("CRANLEY GARDENS"), postTown = "LONDON", postCode = "SW7 3BB")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "UNIT 1-2, DINAN WAY TRADING ESTATE, CONCORDE ROAD, EXMOUTH, EX8 4RS should return in the format UNIT 1-2, DINAN WAY TRADING ESTATE, CONCORDE ROAD, EXMOUTH, EX8 4RS" in {
      val dpa = resultBuilder(buildingName = Some("UNIT 1-2"), dependentThoroughfareName = Some("DINAN WAY TRADING ESTATE"), thoroughfareName = Some("CONCORDE ROAD"), postTown = "EXMOUTH", postCode = "EX8 4RS")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "6, BRIXINGTON PARADE, CHURCHILL ROAD, EXMOUTH, EX8 4RJ should return in the format 6 BRIXINGTON PARADE, CHURCHILL ROAD, EXMOUTH, EX8 4RJ" in {
      val dpa = resultBuilder(buildingNumber = Some("6"), dependentThoroughfareName = Some("BRIXINGTON PARADE"), thoroughfareName = Some("CHURCHILL ROAD"), postTown = "EXMOUTH", postCode = "EX8 4RJ")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "6, PARK VIEW, WOTTON LANE, LYMPSTONE, EXMOUTH, EX8 5LY should return in the format 6 PARK VIEW, WOTTON LANE, LYMPSTONE, EXMOUTH, EX8 5LY" in {
      val dpa = resultBuilder(buildingNumber = Some("6"), dependentThoroughfareName = Some("PARK VIEW"), thoroughfareName = Some("WOTTON LANE"), dependentLocality = Some("LYMPSTONE"), postTown = "EXMOUTH", postCode = "EX8 5LY")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "7, VILLA MAISON, 4, CYPRUS ROAD, EXMOUTH, EX8 2DZ should return in the format 7 VILLA MAISON, 4 CYPRUS ROAD, EXMOUTH, EX8 2DZ" in {
      val dpa = resultBuilder(subBuildingName = Some("7"), buildingName = Some("VILLA MAISON"), buildingNumber = Some("4"), thoroughfareName = Some("CYPRUS ROAD"), postTown = "EXMOUTH", postCode = "EX8 2DZ")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "FLAT 1,HEATHGATE,7,LANSDOWNE ROAD,BUDLEIGH SALTERTON,EX9 6AH should return in the format FLAT 1 HEATHGATE, 7 LANSDOWNE ROAD, BUDLEIGH SALTERTON, EX9 6AH" in {
      val dpa = resultBuilder(subBuildingName = Some("FLAT 1"), buildingName = Some("HEATHGATE"), buildingNumber = Some("7"), thoroughfareName = Some("LANSDOWNE ROAD"), postTown = "BUDLEIGH SALTERTON", postCode = "EX9 6AH")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "FLAT, COURTLANDS CROSS SERVICE STATION, 397, EXETER ROAD, EXMOUTH, EX8 3NS should return in the format FLAT COURTLANDS CROSS SERVICE STATION, 397 EXETER ROAD, EXMOUTH, EX8 3NS" in {
      val dpa = resultBuilder(subBuildingName = Some("FLAT"), buildingName = Some("COURTLANDS CROSS SERVICE STATION"), buildingNumber = Some("397"), thoroughfareName = Some("EXETER ROAD"), postTown = "EXMOUTH", postCode = "EX8 3NS")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "2, THE RED LODGE, 11, ELWYN ROAD, EXMOUTH, EX8 2EL should return in the format 2 THE RED LODGE, 11 ELWYN ROAD, EXMOUTH, EX8 2EL" in {
      val dpa = resultBuilder(subBuildingName = Some("2"), buildingName = Some("THE RED LODGE"), buildingNumber = Some("11"), thoroughfareName = Some("ELWYN ROAD"), postTown = "EXMOUTH", postCode = "EX8 2EL")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "40, SKETTY PARK DRIVE, SKETTY, SWANSEA, SA2 8LN should return in the format 40 SKETTY PARK DRIVE, SKETTY, SWANSEA, SA2 8LN" in {
      val dpa = resultBuilder(buildingNumber = Some("40"), thoroughfareName = Some("SKETTY PARK DRIVE"), dependentLocality = Some("SKETTY"), postTown = "SWANSEA", postCode = "SA2 8LN")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "4, LYNDHURST ROAD, EXMOUTH, EX8 3DT should return in the format 4 LYNDHURST ROAD, EXMOUTH, EX8 3DT" in {
      val dpa = resultBuilder(buildingNumber = Some("4"), thoroughfareName = Some("LYNDHURST ROAD"), postTown = "EXMOUTH", postCode = "EX8 3DT")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
    ...
    "ASH COTTAGE, OLD BYSTOCK DRIVE, BYSTOCK, EXMOUTH, EX8 5EQ should return in the format ASH COTTAGE, OLD BYSTOCK DRIVE, BYSTOCK, EXMOUTH, EX8 5EQ" in {
      val dpa = resultBuilder(buildingName = Some("ASH COTTAGE"), thoroughfareName = Some("OLD BYSTOCK DRIVE"), dependentLocality = Some("BYSTOCK"), postTown = "EXMOUTH", postCode = "EX8 5EQ")
      val service = lookupCommandWithCallOrdnanceSurveyStub(Some(Response(header, Some(dpa))))
      val result = service(PostcodeToAddressLookupRequest(postcodeValid))
...
//      whenReady(result) { r =>
//        r.addresses.length should equal(dpa.length)
//        r shouldBe PostcodeToAddressResponse(Seq(UprnAddressPair(traderUprnValid.toString, s"DVLA, ASH COTTAGE, OLD BYSTOCK DRIVE, BYSTOCK, EXMOUTH, EX8 5EQ")))
//      }
//    }
  }
  ...
  "call UprnToAddressOSWebService" should {
      ...
      whenReady(result) { r =>
        r.addressViewModel match {
          case Some(addressViewModel) =>
            val expected = dpa.head.DPA.head
            addressViewModel.uprn.map(_.toString) should equal(Some(expected.UPRN))
            addressViewModel.address should equal(Seq("ASH COTTAGE", "OLD BYSTOCK DRIVE", "BYSTOCK", "EXMOUTH", "EX8 5EQ"))
    ...
    "return without organisation name in the address even when one exists" in {
      ...
      whenReady(result) { r =>
        r.addressViewModel match {
          case Some(addressViewModel) =>
            val expectedWithoutOrganisation = resultBuilder(organisationName = None, buildingName = Some("ASH COTTAGE"), thoroughfareName = Some("OLD BYSTOCK DRIVE"), dependentLocality = Some("BYSTOCK"), postTown = "EXMOUTH", postCode = "EX8 5EQ").head.DPA.head
            addressViewModel.uprn.map(_.toString) should equal(Some(expectedWithoutOrganisation.UPRN))
            addressViewModel.address should equal(Seq("ASH COTTAGE", "OLD BYSTOCK DRIVE", "BYSTOCK", "EXMOUTH", "EX8 5EQ"))
          case _ => fail("Should have returned Some(AddressViewModel)")
        }
      }
