...
class JsonFormatsSpec extends WordSpec with Matchers {
  ...
  "JsonFormats" should {
    ...
    "successfully unmarshall ordnancesurveya valid json postcode to address lookup response payload into ordnancesurveya response object" in {
    ...
    "successfully unmarshall ordnancesurveya valid json uprn to address lookup response payload into ordnancesurveya response object" in {
